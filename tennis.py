...
def check_availability(url):
    ...
    try:
        ...
        with SB(uc=True, headless=True) as sb:
            ...
            not_booked_elements = sb.find_elements("css selector", '.book-interval.not-booked')

            # Process each found element
            for element in not_booked_elements:
                booking_slot_element = element.find_element("css selector", '.available-booking-slot')
                ...
                cost_element = element.find_element("css selector", '.cost')
